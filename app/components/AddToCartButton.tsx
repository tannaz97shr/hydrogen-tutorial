...
export function AddToCartButton({
  ...
  return (
    <CartForm route="/cart" inputs={{lines}} action={CartForm.ACTIONS.LinesAdd}>
        ...
        return (
          <div className="relative">
            ...
            <button
              ...
              className={`
      w-full py-5 px-8
      text-white font-source text-base tracking-wider 
      ...
      bg-brand-navy hover:bg-brand-navyLight
    ...
    `}
            ...
            {isLoading && (
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-brand-cream">
                <div className="w-full bg-gradient-to-r from-brand-gold to-brand-navy animate-progress" />
              </div>
            )}
          </div>
        );
